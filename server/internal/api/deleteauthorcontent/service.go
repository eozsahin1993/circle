...
// All verification lives in logstore.Store.DeleteAuthorContent; this
...
// logged, not returned.
func (s *Service) Delete(ctx context.Context, deletion logstore.AuthorContentDeletion) (logstore.AuthorContentResult, error) {
