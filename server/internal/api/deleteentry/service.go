...
// author-or-admin verification lives in logstore.Store.DeleteEntry; this
...
func (s *Service) Delete(ctx context.Context, deletion logstore.EntryDeletion) (logstore.CommitResult, error) {
