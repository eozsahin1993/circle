...
type request struct {
	...
	// CurrentKeyVersion: always the *pre*-rotation version — see synclog.LogStore.Rotate.
	...
	// Signature: hex, over synclog.RotateMessage(syncId, entryId, newWriteTokenHash).
