...
func TestMessages_MatchTheClientsByteConstruction(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			"mimoza-relay/rotate/v1\x00sync-1\x00entry-1\x00hash-1",
		},
		{
			...
			"mimoza-relay/authority-change/v1\x00add\x00sync-1\x00entry-1\x00key-1",
		},
		{
			...
			"mimoza-relay/authority-change/v1\x00remove\x00sync-1\x00entry-1\x00key-1",
		},
		{
			"CoverPhotoUploadMessage",
			CoverPhotoUploadMessage("sync-1"),
			"mimoza-relay/cover-photo-upload/v1\x00sync-1",
		},
		{
			"DeleteBlobMessage",
			DeleteBlobMessage("sync-1", "entry-1"),
			"mimoza-relay/delete-blob/v1\x00sync-1\x00entry-1",
		},
		{
			"CircleDeletion.Message",
			CircleDeletion{SyncID: "sync-1", EntryID: "entry-1"}.Message(),
			"mimoza-relay/delete-circle/v1\x00sync-1\x00entry-1",
		},
		{
			"EntryDeletion.Message",
			EntryDeletion{SyncID: "sync-1", TargetEntryID: "entry-1", TombstoneEntryID: "tomb-1"}.Message(),
			"mimoza-relay/delete-entry/v1\x00sync-1\x00entry-1\x00tomb-1",
		},
		{
			...
			"mimoza-relay/delete-author-content/v1\x00sync-1\x00author-1\x00tomb-1",
		},
		{
			...
			"mimoza-relay/delete-author-content/v1\x00sync-1\x00author-1\x00",
		},
	}
