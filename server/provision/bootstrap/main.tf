# The bucket every deployed env's state lives in (see envs/*/versions.tf).
...
# state is harmless — `terraform import aws_s3_bucket.state
# mimoza-terraform-state` recovers it.
terraform {
