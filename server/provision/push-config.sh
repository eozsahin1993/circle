...
settings=(
  ...
  MAX_BLOB_SIZE_BYTES INVITE_RETENTION_DAYS
  RATE_LIMIT_WRITE_MAX_REQUESTS RATE_LIMIT_READ_MAX_REQUESTS
  RATE_LIMIT_PUSH_MAX_REQUESTS RATE_LIMIT_WINDOW_MINUTES
)
