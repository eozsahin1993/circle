...
# key from, but that whole path was dead code — real auth ended up keyed
# on the OIDC `sub` claim directly, not email — and got removed along
# with internal/secrets and internal/crypto. Still used for
# sessions/accounts table SSE (see
